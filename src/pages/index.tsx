    ...
    <div className={styles.homepage}>
      ...
      <Head>
        <title>Podcastr</title>
          <script src="https://kit.fontawesome.com/b48090e68d.js"></script>
      </Head>
              ...
              {allEpisodes.map((episode, index) => {
                return (
                  <tr>
                    ...
                    <td>
                      <button type="button">
                        <img src="/play-green.svg" alt="Tocar episodios" onClick={() => playList(episodeList, index + latestEpisodes.length)}/>
                      </button>
                    </td>
                  </tr>
                )
